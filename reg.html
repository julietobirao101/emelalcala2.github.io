...
<h2>CHMSC Regestration Form</h2>

<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Regester</button>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php">
    ...
    <div class="container">
      ...
      <input type="int" placeholder="Enter Number" name="pno" required>
